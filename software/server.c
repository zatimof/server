...
//PB1 - включить резистор 3.3 Ом
//PB2 - включить резистор 2.2 Ом
...
//PC0 - вход RESET (не используется)
//PC1 - вход 0 (не используется)
//PC2 - кнопка TEST
//PC3 - бипер (LOW - ACTIVE)
//PC4 - выход управления кнопкой включения
//PC5 - вход состояния красного светодиода
